            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
                <div className='space-y-6'>
                    ...
                    <p className='text-muted-foreground'>
                        With over 5 years of experiance in web development, I specialize in creating
                        responsive, accessible, and performent web applications using moder technologies.
                    </p>
                    <p className='text-muted-foreground'>
                        I am Passionate about creating elegiant solutions to complex problems, and I am
                ...
                <div className='grid grid-cols-1 gap-6'>
                    <div className='background-gradient p-6 card-hover'>
                        ...
                        <div className='flex items-start gap-4'>
                            ...
                            <User className='h-6 w-6 text-primary'/>
                             ...
                             <div className='text-left'>
                                ...
                                <p className='text-muted-foreground'>Designing intuitive user interfaces and seamless user experiances.</p>
                            </div>
                        </div>
                    </div>
                    <div className='background-gradient p-6 card-hover'>
